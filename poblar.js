...
async function poblarInventarioReal() {
    ...
    try {
        ...
        const articulos = [
            // BOTELLAS Y GALONERAS (Stock contado general)
            ['Botella de 200 ml - B-1', 'BOTELLAS Y GALONERAS', 23326, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Botella de 500 ml - B-1', 'BOTELLAS Y GALONERAS', 10906, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Botella de 900 ml - B-1', 'BOTELLAS Y GALONERAS', 0, 'UNIDADES', 'REALIZAR PEDIDO'],
            ['Botella de 1 Lt - B-1', 'BOTELLAS Y GALONERAS', 56619, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Botella de 2 Lt - B-1', 'BOTELLAS Y GALONERAS', 0, 'UNIDADES', 'REALIZAR PEDIDO'],
            ['Galonera B-1 x 5 lt', 'BOTELLAS Y GALONERAS', 1038, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Botella de 800ml - Don Lalo', 'BOTELLAS Y GALONERAS', 3604, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Botella Belini x 3 lt', 'BOTELLAS Y GALONERAS', 952, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Botella Belini x 200 ml', 'BOTELLAS Y GALONERAS', 12250, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Botella Belini x 500 ml', 'BOTELLAS Y GALONERAS', 18757, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Botella Belini x 900 ml', 'BOTELLAS Y GALONERAS', 7087, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Botella Belini x 1 Lt', 'BOTELLAS Y GALONERAS', 2092, 'UNIDADES', 'STOCK SUFICIENTE'],
            ...
            ['Lata Belini 18lt', 'BOTELLAS Y GALONERAS', 1400, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Balde Belini x 18 lt', 'BOTELLAS Y GALONERAS', 5, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Balde Don Lalo x 20lt', 'BOTELLAS Y GALONERAS', 185, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Botella VEGA x 900 ml', 'BOTELLAS Y GALONERAS', 0, 'UNIDADES', 'REALIZAR PEDIDO'],

            // CAJAS (Insumo vacío)
            ['Caja B-1 x 200 ml', 'CAJAS', 2194, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Caja B-1 x 500 ml', 'CAJAS', 14262, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Caja B-1 x 900 ml', 'CAJAS', 72915, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Caja B-1 x 1 lt', 'CAJAS', 0, 'UNIDADES', 'REALIZAR PEDIDO'],
            ['Caja B-1 x 2 lt', 'CAJAS', 1965, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Caja B-1 x 5 lt', 'CAJAS', 2338, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Caja Don Lalo x 800ml x 12 und', 'CAJAS', 25615, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Caja Belini x 200 ml', 'CAJAS', 7772, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Caja Belini x 500 ml', 'CAJAS', 33119, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Caja Belini x 900 ml', 'CAJAS', 14435, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['CAJA BELINI X 1 LITRO', 'CAJAS', 21514, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Caja Belini x 2 lt', 'CAJAS', 1429, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Caja Belini x 5 lt', 'CAJAS', 5579, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['Caja BELINI X 3 LITROS', 'CAJAS', 4304, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['CAJA TIMONEL 900ML X 12 UND', 'CAJAS', 4251, 'UNIDADES', 'STOCK SUFICIENTE'],
            ['CAJA ACEITE VEGA 900ML X 12 UND', 'CAJAS', 5314, 'UNIDADES', 'STOCK SUFICIENTE'],

            // TAPAS Y ACCESORIOS
            ['Tapa dosif. N° 26 blanco / Dorado', 'TAPAS Y ACCESORIOS', 75.04, 'MILL', 'STOCK SUFICIENTE'],
            ['Tapa Dosif. N° 26 blanco / Celeste', 'TAPAS Y ACCESORIOS', 0.00, 'MILL', 'REALIZAR PEDIDO'],
            ['Tapa dosif. N° 28 blanco / Dorado', 'TAPAS Y ACCESORIOS', 25.82, 'MILL', 'STOCK SUFICIENTE'],
            ['Asas plasticas /Dorado (2LT)', 'TAPAS Y ACCESORIOS', 4.00, 'MILL', 'STOCK SUFICIENTE'],
            ...
            ['Tapa Tapon 26mm (200ml)', 'TAPAS Y ACCESORIOS', 32.57, 'MILL', 'STOCK SUFICIENTE'],
            ['Tapa color Celeste 3lt', 'TAPAS Y ACCESORIOS', 7.60, 'MILL', 'STOCK SUFICIENTE'],
            ...
            ['Tapa Dosif. N° 26 blanco / ROJO', 'TAPAS Y ACCESORIOS', 65.87, 'MILL', 'STOCK SUFICIENTE'],
            ['Tapa Dosif. N° 26 blanco / VERDE', 'TAPAS Y ACCESORIOS', 53.21, 'MILL', 'STOCK SUFICIENTE'],

            // PREFORMAS Y SERVICIOS
            ['SERVICIO SAUÑE (1LT-900ML)', 'PREFORMAS Y SERVICIOS', 55.95, 'MILL', 'STOCK SUFICIENTE'],
            ['SERVICIO SAUÑE PREFORMA 09 GR (200ML)', 'PREFORMAS Y SERVICIOS', 75.00, 'MILL', 'STOCK SUFICIENTE'],
            ['Preforma cristal 23.5 gr (PICO 26MM)', 'PREFORMAS Y SERVICIOS', 38.41, 'MILL', 'STOCK SUFICIENTE'],
            ...
            ['Preforma cristal 15 GR (26 MLL - 500ML)', 'PREFORMAS Y SERVICIOS', 40.00, 'MILL', 'STOCK SUFICIENTE'],
            ...
            ['SERVICIO B&M DYLPLAST (PREFORMAS 23.5GR)', 'PREFORMAS Y SERVICIOS', 88.85, 'MILL', 'STOCK SUFICIENTE'],
            ['Preforma cristal 21 gr (PICO 26MM)', 'PREFORMAS Y SERVICIOS', 98.00, 'MILL', 'STOCK SUFICIENTE'],

            // ETIQUETAS
            ['Etiqueta couche 90 gr x 200 ml B-1', 'ETIQUETAS', 85.00, 'MILL', 'STOCK SUFICIENTE'],
            ...
            ['Etiqueta couche 90 gr x 1 lt B-1', 'ETIQUETAS', 135.28, 'MILL', 'STOCK SUFICIENTE'],
            ...
            ['Etiqueta couche 90gr x 800 ml Don Lalo', 'ETIQUETAS', 76.34, 'MILL', 'STOCK SUFICIENTE'],
            ['Etiqueta couche 90 gr x 500 ml Belini', 'ETIQUETAS', 136.74, 'MILL', 'STOCK SUFICIENTE'],
            ['Etiqueta couche 90 gr x 900 ml Belini', 'ETIQUETAS', 50.00, 'MILL', 'STOCK SUFICIENTE'],
            ['Etiqueta couche 90 gr x 1 lt Belini', 'ETIQUETAS', 40.00, 'MILL', 'STOCK SUFICIENTE'],
            ['Etiqueta polipropileno blanco x 3 lt Belini', 'ETIQUETAS', 27.64, 'MILL', 'STOCK SUFICIENTE'],
            ['Etiqueta couche 90 gr x 200 ml Belini', 'ETIQUETAS', 40.00, 'MILL', 'STOCK SUFICIENTE'],
            ['Etiqueta polipropileno blanco x 2 lt Belini', 'ETIQUETAS', 23.98, 'MILL', 'STOCK SUFICIENTE'],
            ['Etiqueta polipropileno blanco x 5 lt Belini', 'ETIQUETAS', 22.00, 'MILL', 'STOCK SUFICIENTE'],
            ['Etiqueta couche 90 gr x 900ml TIMONEL', 'ETIQUETAS', 11.00, 'MILL', 'STOCK SUFICIENTE'],
            ['Etiqueta couche 90 gr x 900 ml VEGA', 'ETIQUETAS', 6.60, 'MILL', 'STOCK SUFICIENTE']
        ];
